...
store_str print_full_uhex_str, '2. Вывести полное беззнаковое число в шестнадцатиричной СС'
store_str print_byte_idec_str, '3. Вывести младший байт числа как знаковое число в десятиричной СС'
